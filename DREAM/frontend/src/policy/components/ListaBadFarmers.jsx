...
import { Form, Card, Button, Icon, Modal, Label } from "semantic-ui-react";
      ...
      >
        ...
        <Modal.Content scrolling>
          <Modal.Description>
            <Form>
              <Label>
                Select agronomist for the steering initiative
              </Label>
              {/* dropdown degli agronomists */}
            </Form>
          ...
          <table class="ui celled table">
            ...
            <tbody>
              {props.farmers.map((farmer) => (
                <tr>
                  <td className="text-center mt-3 pt-3 justify-content-center">{farmer.mail}</td>
